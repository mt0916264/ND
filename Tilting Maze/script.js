...
function resetGame() {
  ...
  if (hardMode) {
    noteElement.innerHTML = `Clique no joystick para começar!
        <p>Modo difícil, evite buracos negros. De volta ao modo fácil? Pressione E</p>`;
  } else {
    noteElement.innerHTML = `Clique no joystick para começar!
        <p>Mova todas as bolas para o centro. Pronto para o modo difícil? Pressione H</p>`;
  }
  ...
  try {
    ...
    if (
      ...
      noteElement.innerHTML = `Parabéns, você conseguiu!
        ...
        <p>
          Telegram
          <a href="https://t.me/NDBIGODE" , target="_top"
            >@NDBIGODE</a
          >
        </p>`;
      noteElement.style.opacity = 1;
